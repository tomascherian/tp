...
public class SampleDataUtil {
    ...
    public static Meeting[] getSampleMeetings() {
        ...
        return new Meeting[] {
            new Meeting(new MeetingName("CS2103T project"), new MeetingDate("12/04/2022"),
                        new StartTime("1600"), new EndTime("1700"),
                        getParticipantSet(samplePersons[0], samplePersons[1]), new MeetingArchiveStatus(false),
                    getTagSet("v1point2")),
            new Meeting(new MeetingName("CS2101 project"), new MeetingDate("15/05/2022"),
                        new StartTime("1900"), new EndTime("2000"),
                        getParticipantSet(samplePersons[0], samplePersons[1]), new MeetingArchiveStatus(false),
                    getTagSet("OP2")),
            new Meeting(new MeetingName("NUSSU meeting"), new MeetingDate("20/06/2022"),
                        new StartTime("1600"), new EndTime("1700"),
                        getParticipantSet(samplePersons[3], samplePersons[1]), new MeetingArchiveStatus(false),
                    getTagSet("important")),
            new Meeting(new MeetingName("Dance exco meeting"), new MeetingDate("22/07/2022"),
                        new StartTime("1700"), new EndTime("1800"),
                        getParticipantSet(samplePersons[0], samplePersons[3]), new MeetingArchiveStatus(false),
                    getTagSet()),
            new Meeting(new MeetingName("Computing club meeting"), new MeetingDate("30/08/2022"),
                        new StartTime("1600"), new EndTime("1700"),
